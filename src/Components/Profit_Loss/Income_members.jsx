...
const Income_members = ({ period }) => {
    const {
        memberIncome,
        loading,
    } = useAdditionalIncomes(period);
            ...
            {loading ? (
                ...
                <>
                    <div className="flex">
                        ...
                        <div className="flex-1 flex items-end justify-around h-64 border-l border-b border-slate-100 pl-6">
                    ...
                    <div className="flex justify-around pl-20 mt-4 text-center text-xs text-slate-600">
                        {memberIncome.map((item, index) => (
                            <span
                                key={`${item.name}-${index}`}
